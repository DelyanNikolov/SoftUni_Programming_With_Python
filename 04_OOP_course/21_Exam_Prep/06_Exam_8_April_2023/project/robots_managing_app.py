...
class RobotsManagingApp:
    ...
    def add_robot_to_service(self, robot_name: str, service_name: str):
        ...
        robot_sex = robot.__class__.__name__
        name_of_service = service.__class__.__name__

        if robot_sex == "MaleRobot" and name_of_service == "MainService":
            can_be_added = True
        elif robot_sex == "FemaleRobot" and name_of_service == "SecondaryService":
            can_be_added = True
        else:
            can_be_added = False
