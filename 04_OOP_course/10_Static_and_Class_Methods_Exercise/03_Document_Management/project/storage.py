...
class Storage:
    ...
    def edit_topic(self, topic_id: int, new_topic: str, new_storage_folder: str) -> None:
        # edit the topic with the given id. Replace topic with new topic, replace current folder with new storage folder
    ...
    def edit_document(self, document_id: int, new_file_name: str) -> None:
        # edit the topic with the given id. Renames the document with the new file name
