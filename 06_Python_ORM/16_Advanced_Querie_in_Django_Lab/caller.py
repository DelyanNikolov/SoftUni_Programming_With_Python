...
def product_quantity_ordered():
    all_ordered_products = (Product.objects.annotate(total_ordered_quantity=Sum('orderproduct__quantity'))
...
def give_discount():
    ...
    all_products = Product.objects.filter(Q(is_available=True)).order_by('-price', 'name')
